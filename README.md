...
Для запуска необходимо использовать строку "TestTask.exe *имя_первого_файла*.txt *имя_второго_файла*.txt", программа не будет работать, если указано менее или более двух файлов.
